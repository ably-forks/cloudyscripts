...
class CopyAmiSampleCode
  ...
  def self.run()
    ...
    new_ami_name = "CloudyScripts AMI copy"
    new_ami_description = "Copy of AMI ami-06ad526f from AWS US-East"
...
# Launch Simple test
#
SecludIT::CloudyScripts::CopyAmiSampleCode.run() 
