...
require "scripts/vcloud/open_port_checker"
...
class TestVCloudOpenPortChecker < Test::Unit::TestCase
  def test_execution
    ...
    vcloud_api._create_internet_service("1.2.3.4", 443)
    vcloud_api._create_internet_service("11.22.33.44", 4444)
    ...
    port_checks = [{:port=>443, :ip =>"1.2.3.4", :success=>false}, {:port=>4444, :ip=>"11.22.33.44", :success=>true}]
